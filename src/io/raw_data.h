...
public:
    ...
    {
        return _data[idx].getName();
    }

    const eDataRep   getDataRep()  const
    {
        return _dataRep;
    }
    const eLabelRep  getLabelRep() const
    {
        return _labelRep;
    }
    ...
    {
        return _numAttributes;    //!< Returns the number of attributes.
    }
    int      getNumClasses()    const
    {
        return _classMap.getNumNames();    //!< Returns the number of classes.
    }
    int		 getNumExample() const
    {
        return _numExamples;
    }
    ...
    const string getSepChars()
    {
        return _sepChars;
    }
    const eDataRep getDataRep()
    {
        return _dataRep;
    }
    vector<Example>::iterator rawBegin()
    {
        return _data.begin();
    }
    vector<Example>::iterator rawEnd()
    {
        return _data.end();
    }

    vector< int >&	getExamplesPerClass()
    {
        return _nExamplesPerClass;
    }

...
public:
    ...
    const static uint64_t BINARY = 0x10;
    const static uint64_t NAMEDNOMINAL = 0x20;
    const static uint64_t COMPACTNOMINAL = 0x40;
    const static uint64_t LABEL = 0x80;
    const static uint64_t IGNORE = 0x0100;
    const static uint64_t ORDERED = 0x0200;
    const static uint64_t TARGET = 0x0400;
    const static uint64_t IMPLICIT = 0x0800;
...
inline const std::vector<AttributeDesc>&
    NamesFileReader::getImplicitAttributeMeta() const
{
    return mImplicitAttributeMeta;
}
inline const std::vector<AttributeDesc>& NamesFileReader::getExplicitAttributeMeta() const
{
